...
getControlResults <- function(connection, targetId, comparatorId, analysisId, databaseId, cohortMethodResult, negativeControlOutcome) {
...
getPs <- function(connection, targetIds, comparatorIds, analysisId, databaseId, dataFolder) {
...
getKaplanMeier <- function(connection, targetId, comparatorId, outcomeId, databaseId, analysisId, dataFolder) {
...
getAttrition <- function(connection, targetId, comparatorId, outcomeId, analysisId, databaseId, attrition) {
...
getPropensityModel <- function(connection, targetId, comparatorId, analysisId, databaseId, propensityModel, covariate) {
